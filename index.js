...
/* Task 4: Create a function called get20s() that takes data as an argument and returns an array with 
names of artists who were born in and died in 20th century (1900-2000) example born in 1901 and died in 1959 - included / born in 1889 and died in 1925 not included
...
for (let k of array)
{
  ...
  holder=k.years.split("-");
  holder[0]=Number(holder[0]);
...
bio: I dont wanna brag about myself but my first name is a famous artist first name.
